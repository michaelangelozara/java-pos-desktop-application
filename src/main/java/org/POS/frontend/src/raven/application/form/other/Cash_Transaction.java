...
// ButtonRenderer and ButtonEditor are already defined in your previous code.
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Cash Transaction");

        jPanel2.setBorder(javax.swing.BorderFactory.createEtchedBorder());

        jLabel2.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        jLabel2.setText("List of Cash Transactions");
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
                ...
                new String[]{
                        "#", "Transaction ID", "Reference", "Cash IN", "Cash OUT", "Payment Method", "User", "Date & Time", "Action"
                }
        ) {
