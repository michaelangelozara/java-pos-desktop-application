...
public class Return_Purchase_Details extends javax.swing.JPanel {

    private ReturnPurchase returnPurchase;
    public Return_Purchase_Details(ReturnPurchase returnPurchase) {
    ...
    private void loadUpperTable(){
        ...
        model.addRow(new Object[]{
                this.returnPurchase.getPurchase().getCode(),
                this.returnPurchase.getCode(),
                this.returnPurchase.getPurchase().getCreatedDate(),
                this.returnPurchase.getReturnedAt(),
                this.returnPurchase.getReason(),
                this.returnPurchase.getNote(),
                this.returnPurchase.getStatus().name(),
                this.returnPurchase.getUser().getName()
        });
    }

    private void loadLowerTable(){
        DefaultTableModel model = (DefaultTableModel) table.getModel();
        model.setRowCount(0);

        var returnedPurchase = this.returnPurchase.getPurchaseItems();
        int n = 1;
        for(int i = 0; i < returnedPurchase.size(); i++){

            if(returnedPurchase.get(i).getReturnQuantity() == 0) continue;

            model.addRow(new Object[]{
                    n,
                    returnedPurchase.get(i).getProduct().getCode(),
                    returnedPurchase.get(i).getProduct().getName(),
                    returnedPurchase.get(i).getQuantity(),
                    returnedPurchase.get(i).getReturnQuantity(),
                    returnedPurchase.get(i).getSellingPrice(),
                    returnedPurchase.get(i).getSellingPrice().multiply(BigDecimal.valueOf(returnedPurchase.get(i).getReturnQuantity()))
            });
            n++;
        }
    }
    ...
    private void initComponents() {
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "#", "Code", "Product Name	", "Purchased Qty	", "Returned Qty	", "Selling Price", "Total Return "
            }
        ) {
