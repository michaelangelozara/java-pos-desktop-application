...
import org.POS.backend.inventory_adjustment.InventoryAdjustmentResponseDto;
...
public class InventoryAdjustment_Details extends javax.swing.JPanel {

    private Timer timer;

    private InventoryAdjustmentResponseDto inventoryAdjustment;
    ...
    private void loadLogs() {
        ...
        SwingWorker<List<InventoryAdjustmentResponseDto>, Void> worker = new SwingWorker<List<InventoryAdjustmentResponseDto>, Void>() {
            @Override
            protected List<InventoryAdjustmentResponseDto> doInBackground() throws Exception {
                return inventoryAdjustmentService.getAllValidInventoryAdjustment();
            }
    ...
    private void filterList() {
        ...
        SwingWorker<List<InventoryAdjustmentResponseDto>, Void> worker = new SwingWorker<List<InventoryAdjustmentResponseDto>, Void>() {
            @Override
            protected List<InventoryAdjustmentResponseDto> doInBackground() {
                return inventoryAdjustmentService.getAllValidInventoryAdjustmentByQuery(query);
            }
    ...
    private void initComponents() {
        ...
        jLabel12.setText("Inventory Adjustment Details ");
        ...
        jLabel15.setText("Adjusted Products: ");
                ...
                jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel6Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        ...
                                        .addComponent(jScrollPane3, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 1262, Short.MAX_VALUE)
                                        .addGroup(jPanel6Layout.createSequentialGroup()
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
                ...
                new String[]{
                        "Adjustment No", "Adjustment Date", "Product Name", "Quantity", "Adjustment Type", "Created By"
                }
        ));
