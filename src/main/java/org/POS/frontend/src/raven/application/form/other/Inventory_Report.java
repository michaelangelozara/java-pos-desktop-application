...
public class Inventory_Report extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jComboBox1.addActionListener(e -> {
            String categoryName = jComboBox1.getSelectedItem() == null ? "" : (String) jComboBox1.getSelectedItem();
            ...
            for (int i = 0; i < subcategories.size(); i++) {
                jComboBox2.addItem(subcategories.get(i).name());
        ...
        jComboBox2.addActionListener(e -> {
            String subcategoryName = jComboBox2.getSelectedItem() == null ? "" : (String) jComboBox2.getSelectedItem();
            ...
            jLabel16.setText(subcategoryName);
